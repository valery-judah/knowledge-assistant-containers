# Qwen3 Embedding image for RunPod

This repository contains the complete custom layer used by the
...
The `.dockerignore` file restricts the build context to the three runtime files.
